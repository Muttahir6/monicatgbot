...
'   "{user2} was shot by VICTOR.',
    "{user2} was pricked to death.',
    "{user2} walked into a cactus while trying to escape VICTOR.',
    "{user2} drowned.',
    ...
    "{user2} got finished off by {user1}.",
    ...
    "{user2} fainted.",
    "{user1} is out of usable Pokemon! {user2} whited out!",
    "{user1} is out of usable Pokemon! {user2} blacked out!",
    "{user2} whited out!",
    "{user2} blacked out!",
    ...
    "{user2} was quickscoped by {user1}.",
    ...
    "{user2} got a house call from Doctor VICTOR.",
